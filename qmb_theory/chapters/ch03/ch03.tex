...
格林函数（Green's function）是多体理论的核心对象之一。本章把 Mahan 的谱表示/频率求和与 Gross《Many-Particle Theory》的绘景、Gell-Mann--Low、Rayleigh--Schr\"odinger、Goldstone 连锁集群、粒子--空穴、极化传播子、$G_2$、GMB、骨架自洽、$W$/穿衣顶点、准粒子与 Bethe--Salpeter 合在一条链上。
