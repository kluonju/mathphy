...
% Use xeCJK instead of ctex: ctex hard-requires `everysel.sty` which is not
% packaged in this Rocky 9 / TeX Live 2020 EPEL install. xeCJK covers the same
% Chinese typography needs without that dependency.
\usepackage{xeCJK}
...
\textbf{授课:} & 罗凯 & & &  & \textbf{时间:} & 周二第一节、周五第三节\\
\textbf{邮箱:} &  \href{mailto:kluo@njust.edu.cn}{kluo@njust.edu.cn} & & & & \textbf{地点:} & IV-A408
\end{tabular}
\end{minipage}
\rule{6in}{0.4pt}
\end{center}
...
\noindent\textbf{课程网址:} 
\begin{itemize}
\item \url{https://kluonju.github.io/teaching/fall-2026/}
...
\item 梁昆淼\,原著\,刘法\,缪国庆\,邵陆兵\,改编, \textbf{数学物理方法}, 高等教育出版社, 2024, ISBN:978-7-04-063087-9
\item 顾樵, \textbf{数学物理方法}, 科学出版社, 2012, ISBN:9787030330642
\item 王竹溪\,郭敦仁, \textbf{特殊函数概论},北京大学出版社, 2000, ISBN:978-7-30-104530-5
\item George B. Arfken, Hans J. Weber, Frank E. Harris, \textbf{
 Mathematical Methods for Physicists, 7th Edition,} Academic Press, 2013, ISBN:978-0-12-384654-9
\item K.F. Riley, M.P. Hobson, S.J. Bence, \textbf{Mathematical Methods for Physics and Engineering, 3rd Edition}, 
Cambridge University Press, 2006, ISBN:978-0-521-68337-9
...
\begin{center} 
	\begin{itemize}
		\item 预备知识
		\item 复数，复变函数，复数级数，复变函数积分，留数定理
		\item 泛函，变分法，哈密顿原理
		\item 数学物理方程，常微分方程，偏微分方程，定解问题
		\item 傅里叶级数，傅里叶变换，拉普拉斯变换，分离变量法，级数展开解法，格林函数方法
		\item 特殊函数，包括贝塞尔函数，勒让德函数，拉盖尔函数，埃尔米特函数
		\item 数值和分析方法
	\end{itemize}
% \begin{minipage}{5in}
% \begin{flushleft}
...
\vspace*{.15in}
\noindent\textbf{考核方式:}(根据实际情况调整比例) 
\begin{itemize}
	\item 课堂考勤和表现 ($\approx$ 10\%),  
	\item 平时作业 (40\%), 
	\item 随堂测验 ($\approx$ 10\%), 
	\item 期末考试 (40\%) 
\end{itemize}
...
\begin{flushleft}
第5周, 中秋节周五放假, 第6周, 国庆节放假,具体时间待学校通知\\
期末考试 (待教务处通知)   \dotfill 一般结课后1--2周左右 \\
...
\noindent\textbf{注意事项:}
\begin{itemize}
	% \item 请添加课程QQ群(通过搜索群号:1053726899,或扫描下方二维码),
	% 进群后务必将备注改成学号+实名(如01-张三),方便交流; 课程讲义和作业禁止外传;
...
% 		\begin{flushleft}
% 			\includegraphics[width=\textwidth]{qrcode_mphy.jpg}
% 		\end{flushleft}
% 	\end{minipage}
% \end{center}
