...
\textbf{授课:} & 罗凯 & & &  & \textbf{时间:} & 周一、周三\; 第一大节
   8:00 --- 10:25 \\
\textbf{邮箱:} &  \href{mailto:kluo@njust.edu.cn}{kluo@njust.edu.cn} & & & & \textbf{地点:} & IV-A411
\end{tabular}
\end{minipage}
\rule{6in}{0.4pt}
\end{center}
...
\noindent\textbf{课程网址:} 
\begin{itemize}
\item \url{https://kluophysics.github.io/teaching/fall-2025/}
...
\item 顾樵, \textit{数学物理方法}, 科学出版社, 2012, ISBN:9787030330642
...
\item K.F. Riley, M.P. Hobson, S.J. Bence, \textit{Mathematical Methods for Physics and Engineering, 3rd Edition}, 
...
\begin{flushleft}
第三、四周, 国庆节放假      \dotfill 10月1-8日 没有课 \\
期末考试 (待教务处通知)   \dotfill ~ \\
