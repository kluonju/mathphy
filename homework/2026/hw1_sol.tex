...
\begin{scope}
% Case 1: lambda = 1/2, a = 1 -> center (0, 5/3), radius 2/3
\fill (0,5/3) circle (1.5pt) node[above right] {$O_1$};
\draw (0,5/3) circle (2/3);
\fill (0,1) circle (1.5pt) node[left] {$\imath a$};
\fill (0,-1) circle (1.5pt) node[left] {$-\imath a$};
\draw[->] (-1.4,0) -- (1.4,0) node[right] {$\mathrm{Re}$};
\draw[->] (0,-1.6) -- (0,2.4) node[above] {$\mathrm{Im}$};
\node at (0.9, 2.0) {\small $\lambda<1$};
\end{scope}
\end{tikzpicture}
\hspace{1cm}
\begin{tikzpicture}[scale=1.1]
\begin{scope}
% Case 2: lambda = 2, a = 1 -> center (0, -5/3), radius 4/3
\fill (0,-5/3) circle (1.5pt) node[below right] {$O_2$};
\draw (0,-5/3) circle (4/3);
\fill (0,1) circle (1.5pt) node[left] {$\imath a$};
\fill (0,-1) circle (1.5pt) node[left] {$-\imath a$};
\draw[->] (-1.4,0) -- (1.4,0) node[right] {$\mathrm{Re}$};
\draw[->] (0,-2.4) -- (0,1.6) node[above] {$\mathrm{Im}$};
\node at (-1.2, 1.4) {\small $\lambda>1$};
\end{scope}
\end{tikzpicture}
\end{center}
...
\draw (0,0) circle (1);
% Roots of z^4+1=0
\fill (45:1)   circle (1.2pt) node[above right] {$z_0$};
\fill (135:1)  circle (1.2pt) node[above left]  {$z_1$};
\fill (225:1)  circle (1.2pt) node[below left]  {$z_2$};
\fill (315:1)  circle (1.2pt) node[below right] {$z_3$};
\end{tikzpicture}
\hspace{1.2cm}
\begin{tikzpicture}[scale=1.4]
% Axes
...
% Unit circle
\draw (0,0) circle (1);
% Roots for lambda=pi/3, so theta = 2pi/3 = 120 deg
\fill (120:1) circle (1.2pt) node[above left]  {$z_1$};
\fill (-120:1) circle (1.2pt) node[below left] {$z_2$};
\fill (-1,0) circle (0.8pt); \fill (1,0) circle (0.8pt);
\draw[dashed] (0,0) -- (120:1);
\draw[dashed] (0,0) -- (-120:1);
\node at (0.6,-1.4) {\small $\lambda=\pi/3$};
\end{tikzpicture}
\end{center}
\end{solution}
