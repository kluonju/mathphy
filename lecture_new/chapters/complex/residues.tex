...
If $f$ is analytic except for isolated singularities $z_j$ inside a positively oriented closed contour $C$, the \term{residue theorem} states
\begin{equation}
\oint_Cf(z)\,\mathrm{d}z=2\pi\mathrm{i}\sum_j\operatorname{Res}(f;z_j).
