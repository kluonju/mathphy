...
\end{equation}
For an orthonormal set, the best finite expansion $f\approx\sum_{n=1}^N c_n\varphi_n$ has coefficients $c_n=(f,\varphi_n)$. Positivity of the squared error gives \termidx{Bessel's inequality}{Bessel's inequality},
\begin{equation}
