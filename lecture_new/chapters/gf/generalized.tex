...
Starting from $U_{tt}-a^2\nabla^2 U=-f(\mathbf{r})e^{\mathrm{i}\omega t}$ and writing $U=ue^{\mathrm{i}\omega t}$, one obtains the Helmholtz equation
\begin{equation}
Lu\equiv\nabla^2 u+\frac{\omega^2}{a^2}u=f(\mathbf{r}),
\end{equation}
