...
+\iiint_{T}\nabla u\cdot\nabla v\,\mathrm{d}V.
\end{equation}
This is \textbf{Green's first identity}. Interchanging $u$ and $v$ produces the companion identity
\begin{equation}
\iint_{\Sigma} v\,\nabla u\cdot\mathrm{d}\mathbf{S}
=\iiint_{T}v\,\Delta u\,\mathrm{d}V
+\iiint_{T}\nabla u\cdot\nabla v\,\mathrm{d}V.
\end{equation}
Subtracting the two relations cancels the gradient products and yields \textbf{Green's second identity}
\begin{equation}
\label{eq:green2}
\iint_{\Sigma}\Bigl(
