...
All angles are measured in radians unless stated otherwise. \termidx{Euler's formula}{Euler's formula} provides the useful bridge between trigonometric and exponential functions:
\begin{equation}
