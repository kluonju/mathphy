...
u(0,t)&=0,\qquad u(\ell,t)=0, &&t\geq0.
\end{aligned}
\right.
...
\begin{align}
u|_{\partial\Omega}&=g &&\text{\term{Dirichlet} condition: the field value is prescribed},\\
\frac{\partial u}{\partial n}\bigg|_{\partial\Omega}&=h &&\text{\term{Neumann} condition: normal flux or slope is prescribed},\\
\alpha u+\beta\frac{\partial u}{\partial n}&=r &&\text{\term{Robin} condition: value and flux are coupled}.
\end{align}
